...
namespace DiziYorumProje.AdminSayfalar
{
    public partial class istatistik : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Label6.Text = db.TBLBLOG.Where(y => y.BLOGID == ( db.TBLYORUM.GroupBy(x => x.YORUMBLOG).OrderByDescending(x => x.Count()).
                Select(z  => z.Key).FirstOrDefault())).Select(k => k.BLOGBASLIK).FirstOrDefault();
        }
    }
}